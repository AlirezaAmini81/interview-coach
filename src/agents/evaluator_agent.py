...
account) and score_quiz_answer (grounded directly in the excerpts the quiz
question came from).
"""
...
SYSTEM_PROMPT = (
    ...
    "own work is a real problem, not a style issue."
)


@traceable(name="evaluator_behavioral", run_type="chain")
def score_answer(topic: str, question: str, answer: str, fact_check_verdict: str | None, llm: LLMProvider) -> dict:
    user_message = (
        f"Topic: {topic}\nQuestion: {question}\nAnswer: {answer}\n"
